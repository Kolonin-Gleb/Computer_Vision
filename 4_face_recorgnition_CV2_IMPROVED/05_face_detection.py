...
mf = open("faces_model_improved.json", 'r')
j_data = mf.read()
mf.close()
model = tf.keras.models.model_from_json(j_data)
model.load_weights('faces_weights_last.hdf5')
...
# https://colab.research.google.com/drive/1-ToTAwJvddy7PFUuX2sjTed4nLwFkjSi?usp=sharing

# Даёт более качественное распознавание, нежели

# Распознавание с использованием модели и весов полученных из Colab
